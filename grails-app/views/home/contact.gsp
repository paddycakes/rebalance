...
<html>
<head>
	<title>Balance | Contact</title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<!-- Bootstrap -->
	<r:require modules="bootstrap-standard"/>
            ...
            <div class="row form">
                ...
                <div class="span5 offset1">
                    <div class="address">
                        <h3>Address</h3>
                        <p>
                            2301 East Lamar Blvd. Suite 199. Arlington. 
                            <br> Unites States, Zip Code, TX 65730.
                        </p>
                        <div class="info">
                        ...
                        <div class="social">
                            ...
                            <a href="#"><i class="social dunno1"></i></a>
                            ...
                            <a href="#"><i class="social dunno2"></i></a>
                            <a href="#"><i class="social dunno3"></i></a>
                            <a href="#"><i class="social rss"></i></a>
                            <a href="#"><i class="social dunno4"></i></a>
                        </div>
                    </div>
                </div>
            </div>
