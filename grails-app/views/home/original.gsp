...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${createLinkTo(dir:'css',file:'theme.css')}" >
    <link rel="stylesheet" type="text/css" href="${createLinkTo(dir:'css',file:'animate.css')}" >
...
<body>
        ...
        <div class="container">
    		<a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
          	...
          	<a class="brand scroller" data-section="body" href="index.html">
                <img src="${createLinkTo(dir:'img',file:'logo.png')}" alt="logo" />
            </a>
                    ...
                    <div id="myCarousel" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="active item slide1">
                                <div class="row">
                                    <div class="span6">
                                        <img src="${createLinkTo(dir:'img',file:'slide1.png')}" alt="slide1" />
                                    </div>
                                    <div class="span4">
                                        <h1>
                            ...
                            <div class="item slide2">
                                <div class="row">
                                    ...
                                    <div class="span6 animated fadeInDownBig">
                                        <img src="${createLinkTo(dir:'img',file:'slide2.png')}" alt="slide2" />
                                    </div>
                                </div>
                            </div>
                            <!-- slide -->
                            <div class="item slide3 animated fadeInUpBig">
                                <img src="${createLinkTo(dir:'img',file:'slide3.png')}" alt="slide3" />
                            </div>
                        </div>
                        <!-- Carousel nav -->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="span4 feature">
                    <img src="${createLinkTo(dir:'img',file:'feature1.jpg')}" alt="feature1" class="thumb" />
                    <h3>
                ...
                <div class="span4 feature">
                    <img src="${createLinkTo(dir:'img',file:'feature2.jpg')}" alt="feature2" class="thumb" />
                    <h3>
                ...
                <div class="span4 feature">
                    <img src="${createLinkTo(dir:'img',file:'feature3.jpg')}" alt="feature3" class="thumb" />
                    <h3>
                ...
                <div class="phrase">
                    <div class="row">
                        ...
                        <div class="span3 offset1">
                            <div class="pic">
                                <img src="${createLinkTo(dir:'img',file:'pic1.jpg')}" alt="author" class="img-circle" />
                ...
                <div class="span8">
                    ...
                    <div class="blog_post">
                        <div class="row">
                            <div class="span2">
                                <a href="blog.html">
                                    <img src="${createLinkTo(dir:'img',file:'pic_blog.png')}" alt="post image" class="img-circle" />
                                </a>
                            </div>
                            <div class="span4">
    ...
    <script src="${createLinkTo(dir:'js',file:'bootstrap.min.js')}"></script>
    <script src="${createLinkTo(dir:'js',file:'theme.js')}"></script>
</body>
</html>